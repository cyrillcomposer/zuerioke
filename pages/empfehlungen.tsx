...
export default function Empfehlungen() {
  ...
  const songs = {
    ...
    swissGerman: [
      ...
      { song: "Igendwie, Irgendwo", artist: "Nena" },
      { song: "W. Nuss vo. Bümpliz", artist: "Patent Ochsner" },
    ...
    techno: [
      ...
      { song: "Summertime Sadness (Cedric Gervais Remix)", artist: "Lana del Rey" },
      { song: "Freed from Desire", artist: "Gala" },
      { song: "Désenchantée", artist: "Kate Ryan" },
    ...
    rock: [
      { song: "Fight for your Right", artist: "Beastie Boys" },
      { song: "Narcotic", artist: "Liquido" },
    ...
    allTimeHits: [
      ...
      { song: "The Time of my Life", artist: "Dirty Dancing" },
    ...
    italianFrench: [
      { song: "Sarà perché ti amo", artist: "Ricchi e Poveri" },
      ...
      { song: "Voyage Voyage", artist: "Desireless" },
      { song: "Dernière danse", artist: "Indila" },
      { song: "Papaoutai", artist: "Stromae" },
      { song: "Moi... Lolita", artist: "Alizée" },
    ],
    christmas: [
  ...
  const categories = [
    ...
    { key: 'rock', icon: '🤘', songs: songs.rock },
    ...
    { key: 'italianFrench', icon: '🗼', songs: songs.italianFrench },
