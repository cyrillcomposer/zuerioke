...
type QrStageProps = {
  copy: Record<Lang, QrStageCopy>;
  qrSrc: string;
  qrAlt: string;
  badge?: ReactNode;
  defaultVariant?: Variant;
  defaultLang?: Lang;
  fullscreenNote?: string;
};
...
export default function QrStage({
  ...
  defaultVariant = "dark",
  defaultLang = "de",
  fullscreenNote = "Vollbild · Esc beendet",
}: QrStageProps) {
    ...
    <>
      <div className="page">
        <div className="bar">
          ...
          <span className="note">{fullscreenNote}</span>
        </div>
        ...
        <div ref={stageRef} className={`stage ${variant}`}>
          ...
          <div className="left">
            <div className="body">
              ...
              {badge && <div className="stars">{badge}</div>}
              <h1>
                {t.headLine1}
                <br />
            ...
            <div className="foot">
              <span>{t.footLead}</span> &nbsp;·&nbsp; <span className="hl">www.zuerioke.ch</span> &nbsp;·&nbsp; @zuerioke
            </div>
          </div>
